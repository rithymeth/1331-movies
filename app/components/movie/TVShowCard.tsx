...
const TVShowCard = ({ id, name, poster, year, rating = 0, voteCount = 0, overview = '' }: TVShowCardProps) => {
  return (
    <Link href={`/tv-shows/${id}`} className="block group">
      <div className="relative aspect-[2/3] w-full overflow-hidden rounded-xl border border-white/10 bg-[#11161d] transition-all duration-500 group-hover:-translate-y-1 group-hover:border-cyan-300/40 group-hover:shadow-2xl">
        <div className="absolute inset-0">
          {poster ? (
            <>
              ...
              <div className="absolute inset-0 bg-cyan-300/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
