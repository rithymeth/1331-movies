...
export default function TVShowClient({ tvShowId, initialData }: Props) {
  ...
  useEffect(() => {
    ...
    const streamingUrls = [
      `https://vidsrc.cc/v2/embed/tv/${tvShow.id}/${selectedSeason}/${selectedEpisode}`,
      `https://vidsrc.to/embed/tv/${tvShow.id}/${selectedSeason}/${selectedEpisode}`,
      `https://2embed.org/embed/tv?id=${tvShow.id}&s=${selectedSeason}&e=${selectedEpisode}`,
      `https://multiembed.mov/directstream.php?video_id=${tvShow.id}&tmdb=1&s=${selectedSeason}&e=${selectedEpisode}`
    ];

    console.log('TV show streaming URLs:', streamingUrls);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[350px_1fr] gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                {tvShow.genres.map((genre) => (
                  <span key={genre.id} className="px-4 py-2 glass-dark rounded-xl text-sm font-medium border border-white/10">
                    {genre.name}
                  </span>
                ))}
              </div>
            ...
            <div className="space-y-6">
              ...
              {/* Season Selector */}
              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-white">Select Season</h3>
                <div className="flex flex-wrap gap-3">
                  {tvShow.seasons
              ...
              <div className="space-y-4">
                ...
                {isLoading ? (
                  ...
                  <div className="aspect-video glass-dark rounded-2xl flex flex-col items-center justify-center space-y-4">
                ...
                <div className="flex justify-between items-center pt-4">
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 glass-dark rounded-xl border border-white/10 text-white hover:border-purple-500/30 transition-all duration-300"
                  >
